...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8288600086739882)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8289224030739883)
,p_name=>'Automations Log'
...
,p_owner=>'PBUS'
,p_internal_uid=>8289224030739883
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8289945378739895)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8290376617739896)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8290750868739897)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8291126542739898)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8291530145739900)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8291998767739901)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8292339140739902)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8292728696739903)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8293108055739904)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8296595933739914)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'82966'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8297452504739916)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8288600086739882)
