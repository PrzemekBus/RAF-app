...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8136395225738737)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1808154784852622389)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1808154229840622388)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8137072571738743)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8137388895738745)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8137631697738746)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8137910198738747)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8138266459738748)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8137631697738746)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1808154784852622389)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8138593227738750)
,p_plugin_attribute_id=>wwv_flow_imp.id(8138266459738748)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8138958546738751)
,p_plugin_attribute_id=>wwv_flow_imp.id(8138266459738748)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8139314656738752)
,p_plugin_attribute_id=>wwv_flow_imp.id(8138266459738748)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8139717756738753)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8138266459738748)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8140016208738754)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8140329593738756)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8140626772738757)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8140994539738758)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8141228362738759)
,p_plugin_attribute_id=>wwv_flow_imp.id(8140994539738758)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8141661541738760)
,p_plugin_attribute_id=>wwv_flow_imp.id(8140994539738758)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8142073515738762)
,p_plugin_attribute_id=>wwv_flow_imp.id(8140994539738758)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8142435248738763)
,p_plugin_attribute_id=>wwv_flow_imp.id(8140994539738758)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8142837683738764)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8137910198738747)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1808154229840622388)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8143138634738765)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8143413269738766)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8143755165738767)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8144044521738769)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8144313674738770)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8144665650738771)
,p_plugin_attribute_id=>wwv_flow_imp.id(8144313674738770)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8145085496738772)
,p_plugin_attribute_id=>wwv_flow_imp.id(8144313674738770)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8145423583738773)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8145714597738774)
,p_plugin_attribute_id=>wwv_flow_imp.id(8145423583738773)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8146189033738775)
,p_plugin_attribute_id=>wwv_flow_imp.id(8145423583738773)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8146569522738776)
,p_plugin_attribute_id=>wwv_flow_imp.id(8145423583738773)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8146989446738778)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8147277072738779)
,p_plugin_attribute_id=>wwv_flow_imp.id(8146989446738778)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8147652789738780)
,p_plugin_attribute_id=>wwv_flow_imp.id(8146989446738778)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8148034464738781)
,p_plugin_attribute_id=>wwv_flow_imp.id(8146989446738778)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8148417209738782)
,p_plugin_attribute_id=>wwv_flow_imp.id(8146989446738778)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8148865929738784)
,p_plugin_attribute_id=>wwv_flow_imp.id(8146989446738778)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8149253340738785)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8149542064738786)
,p_plugin_attribute_id=>wwv_flow_imp.id(8149253340738785)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8149936352738787)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808357837009769017)
,p_plugin_id=>wwv_flow_imp.id(8136395225738737)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
