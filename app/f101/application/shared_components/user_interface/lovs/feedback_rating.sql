...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8344470827754790)
,p_lov_name=>'FEEDBACK_RATING'
,p_lov_query=>'.'||wwv_flow_imp.id(8344470827754790)||'.'
,p_location=>'STATIC'
,p_version_scn=>41475967173208
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8344786149754790)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8345170771754791)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8345504177754792)
