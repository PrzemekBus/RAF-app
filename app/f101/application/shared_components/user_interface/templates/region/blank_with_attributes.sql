...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7938812391738128)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7939177076738129)
,p_plug_template_id=>wwv_flow_imp.id(7938812391738128)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7939469279738130)
,p_plug_template_id=>wwv_flow_imp.id(7938812391738128)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7939725426738131)
,p_plug_template_id=>wwv_flow_imp.id(7938812391738128)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7940087356738131)
,p_plug_template_id=>wwv_flow_imp.id(7938812391738128)
,p_name=>'Sub Regions'
