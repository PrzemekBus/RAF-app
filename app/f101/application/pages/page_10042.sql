...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8315092435739970)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8315103345739970)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8317924606739978)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(8315103345739970)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8318352172739979)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8316145259739974)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8317570930739977)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8318671902739979)
,p_name=>'P10042_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8315092435739970)
,p_item_source_plug_id=>wwv_flow_imp.id(8315092435739970)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8319011884739980)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8319450001739981)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8319850840739983)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(8321151199739990)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8316266483739974)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8316145259739974)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8316939344739975)
,p_event_id=>wwv_flow_imp.id(8316266483739974)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8321453620739991)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_region_id=>wwv_flow_imp.id(8315092435739970)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Manage User Access'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8321453620739991
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8321831310739992)
...
,p_attribute_08=>'N'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8321831310739992
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8322226840739993)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>8322226840739993
);
