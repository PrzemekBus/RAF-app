...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7975605185738209)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7975986714738210)
,p_plug_template_id=>wwv_flow_imp.id(7975605185738209)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7976287483738211)
,p_plug_template_id=>wwv_flow_imp.id(7975605185738209)
,p_name=>'Sub Regions'
