...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7967513921738191)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7967856475738192)
,p_plug_template_id=>wwv_flow_imp.id(7967513921738191)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7968190460738193)
,p_plug_template_id=>wwv_flow_imp.id(7967513921738191)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7968468951738193)
,p_plug_template_id=>wwv_flow_imp.id(7967513921738191)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7968778160738194)
,p_plug_template_id=>wwv_flow_imp.id(7967513921738191)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7969066623738194)
,p_plug_template_id=>wwv_flow_imp.id(7967513921738191)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7969333308738195)
,p_plug_template_id=>wwv_flow_imp.id(7967513921738191)
,p_name=>'Sub Regions'
