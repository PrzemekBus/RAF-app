...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8022949578738317)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8023273399738318)
,p_plug_template_id=>wwv_flow_imp.id(8022949578738317)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8023522132738318)
,p_plug_template_id=>wwv_flow_imp.id(8022949578738317)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8023883358738319)
,p_plug_template_id=>wwv_flow_imp.id(8022949578738317)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8024135601738320)
,p_plug_template_id=>wwv_flow_imp.id(8022949578738317)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8024479806738320)
,p_plug_template_id=>wwv_flow_imp.id(8022949578738317)
