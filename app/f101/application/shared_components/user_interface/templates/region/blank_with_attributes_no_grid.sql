...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7940253286738132)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7940562350738133)
,p_plug_template_id=>wwv_flow_imp.id(7940253286738132)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7940852713738133)
,p_plug_template_id=>wwv_flow_imp.id(7940253286738132)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7941106094738134)
,p_plug_template_id=>wwv_flow_imp.id(7940253286738132)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7941416580738134)
,p_plug_template_id=>wwv_flow_imp.id(7940253286738132)
,p_name=>'Sub Regions'
