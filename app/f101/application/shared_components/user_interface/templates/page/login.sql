...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7913598794738074)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7913828911738075)
,p_page_template_id=>wwv_flow_imp.id(7913598794738074)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7914189995738076)
,p_page_template_id=>wwv_flow_imp.id(7913598794738074)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7914449113738076)
,p_page_template_id=>wwv_flow_imp.id(7913598794738074)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7914787435738077)
,p_page_template_id=>wwv_flow_imp.id(7913598794738074)
,p_name=>'Body Footer'
