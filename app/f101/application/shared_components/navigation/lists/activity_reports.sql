...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(8384470783754897)
,p_name=>'Activity Reports'
,p_list_status=>'PUBLIC'
,p_required_patch=>wwv_flow_imp.id(8194407553738939)
,p_version_scn=>41475967174649
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8384861629754898)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8385296278754899)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8385640034754900)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8386035387754901)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8386414211754901)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8386883333754903)
