...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7945954611738144)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7946233595738144)
,p_plug_template_id=>wwv_flow_imp.id(7945954611738144)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7946597258738145)
,p_plug_template_id=>wwv_flow_imp.id(7945954611738144)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7946859519738145)
,p_plug_template_id=>wwv_flow_imp.id(7945954611738144)
,p_name=>'Sub Regions'
