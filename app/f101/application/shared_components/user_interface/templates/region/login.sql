...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8000241066738261)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000519278738262)
,p_plug_template_id=>wwv_flow_imp.id(8000241066738261)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8000822043738262)
,p_plug_template_id=>wwv_flow_imp.id(8000241066738261)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001166459738263)
,p_plug_template_id=>wwv_flow_imp.id(8000241066738261)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001431926738263)
,p_plug_template_id=>wwv_flow_imp.id(8000241066738261)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001750333738264)
,p_plug_template_id=>wwv_flow_imp.id(8000241066738261)
,p_name=>'Sub Regions'
