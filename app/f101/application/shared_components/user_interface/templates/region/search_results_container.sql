...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8002791758738266)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003054983738267)
,p_plug_template_id=>wwv_flow_imp.id(8002791758738266)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003312660738267)
,p_plug_template_id=>wwv_flow_imp.id(8002791758738266)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8003625725738268)
,p_plug_template_id=>wwv_flow_imp.id(8002791758738266)
,p_name=>'Sub Regions'
