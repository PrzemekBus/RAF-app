...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8298011341739917)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(8300462986739924)
,p_name=>'Messages'
,p_template=>wwv_flow_imp.id(7995601249738251)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8300817053739928)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8301270719739929)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8301686826739930)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(8302013888739931)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8298401027739919)
,p_name=>'P10036_LOG_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8298011341739917)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8298880208739920)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8299277948739921)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8299615039739922)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8300055569739923)
...
,p_internal_uid=>8300055569739923
);
