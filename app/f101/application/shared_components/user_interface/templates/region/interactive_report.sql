...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7995601249738251)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7995965822738252)
,p_plug_template_id=>wwv_flow_imp.id(7995601249738251)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7996252155738252)
,p_plug_template_id=>wwv_flow_imp.id(7995601249738251)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7996525592738253)
,p_plug_template_id=>wwv_flow_imp.id(7995601249738251)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7996815643738253)
,p_plug_template_id=>wwv_flow_imp.id(7995601249738251)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7997164495738254)
,p_plug_template_id=>wwv_flow_imp.id(7995601249738251)
,p_name=>'Sub Regions'
