...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8109066231738620)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935346882695810318)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935346327683810317)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1678454263953536804)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8109963660738628)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8110238440738630)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8110557658738631)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8110807491738632)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8111181479738633)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8111457484738634)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8111705465738635)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8111181479738633)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1935346882695810318)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8112048083738637)
,p_plugin_attribute_id=>wwv_flow_imp.id(8111705465738635)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8112450999738638)
,p_plugin_attribute_id=>wwv_flow_imp.id(8111705465738635)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8112882798738639)
,p_plugin_attribute_id=>wwv_flow_imp.id(8111705465738635)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8113210088738640)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8111705465738635)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8113565590738641)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8113837086738643)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8114186465738644)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8114402240738645)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8114708335738646)
,p_plugin_attribute_id=>wwv_flow_imp.id(8114402240738645)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8115103341738647)
,p_plugin_attribute_id=>wwv_flow_imp.id(8114402240738645)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8115512433738649)
,p_plugin_attribute_id=>wwv_flow_imp.id(8114402240738645)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8115903577738650)
,p_plugin_attribute_id=>wwv_flow_imp.id(8114402240738645)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8116347450738651)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8111457484738634)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1935346327683810317)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8116689554738653)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8116985208738654)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8117251321738655)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8117502618738656)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8117846946738657)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8118122311738658)
,p_plugin_attribute_id=>wwv_flow_imp.id(8117846946738657)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8118511359738659)
,p_plugin_attribute_id=>wwv_flow_imp.id(8117846946738657)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8118935101738661)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8119271544738662)
,p_plugin_attribute_id=>wwv_flow_imp.id(8118935101738661)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8119698259738663)
,p_plugin_attribute_id=>wwv_flow_imp.id(8118935101738661)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8120031531738664)
,p_plugin_attribute_id=>wwv_flow_imp.id(8118935101738661)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8120470639738666)
,p_plugin_attribute_id=>wwv_flow_imp.id(8118935101738661)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8120802631738667)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8121106750738668)
,p_plugin_attribute_id=>wwv_flow_imp.id(8120802631738667)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8121512828738669)
,p_plugin_attribute_id=>wwv_flow_imp.id(8120802631738667)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8121998359738670)
,p_plugin_attribute_id=>wwv_flow_imp.id(8120802631738667)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8122376153738672)
,p_plugin_attribute_id=>wwv_flow_imp.id(8120802631738667)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8122711904738673)
,p_plugin_attribute_id=>wwv_flow_imp.id(8120802631738667)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8123182453738674)
,p_plugin_attribute_id=>wwv_flow_imp.id(8120802631738667)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8123512859738675)
,p_plugin_attribute_id=>wwv_flow_imp.id(8120802631738667)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8123972197738677)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8124267572738678)
,p_plugin_attribute_id=>wwv_flow_imp.id(8123972197738677)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8124619309738679)
,p_plugin_attribute_id=>wwv_flow_imp.id(8123972197738677)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8125044451738681)
,p_plugin_attribute_id=>wwv_flow_imp.id(8123972197738677)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8125490053738683)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8125704278738684)
,p_plugin_attribute_id=>wwv_flow_imp.id(8125490053738683)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8126108574738685)
,p_plugin_attribute_id=>wwv_flow_imp.id(8125490053738683)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8126580596738687)
,p_plugin_attribute_id=>wwv_flow_imp.id(8125490053738683)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8126917203738688)
,p_plugin_attribute_id=>wwv_flow_imp.id(8125490053738683)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8127394393738690)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8127687395738691)
,p_plugin_attribute_id=>wwv_flow_imp.id(8127394393738690)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8128003782738692)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8128322826738693)
,p_plugin_attribute_id=>wwv_flow_imp.id(8128003782738692)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8128725820738694)
,p_plugin_attribute_id=>wwv_flow_imp.id(8128003782738692)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8129179222738696)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8129400781738697)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8129706211738698)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1678454263953536804)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8130020056738700)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8130350549738701)
,p_plugin_attribute_id=>wwv_flow_imp.id(8130020056738700)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8130753115738702)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8131049158738704)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816560772911631932)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816562032431636080)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1519609258015873502)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1802967144237225199)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803646444967308303)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816558837844586946)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816560171234600803)
,p_plugin_id=>wwv_flow_imp.id(8109066231738620)
