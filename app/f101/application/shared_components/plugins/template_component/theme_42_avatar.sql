...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8081014388738503)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8081334400738507)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8081675673738509)
,p_plugin_attribute_id=>wwv_flow_imp.id(8081334400738507)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8082003285738510)
,p_plugin_attribute_id=>wwv_flow_imp.id(8081334400738507)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8082488902738511)
,p_plugin_attribute_id=>wwv_flow_imp.id(8081334400738507)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8082851554738513)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8081334400738507)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8083102980738514)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8083421055738515)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8083714995738516)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8084012909738517)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8084374823738519)
,p_plugin_attribute_id=>wwv_flow_imp.id(8084012909738517)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8084779453738520)
,p_plugin_attribute_id=>wwv_flow_imp.id(8084012909738517)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8085171948738521)
,p_plugin_attribute_id=>wwv_flow_imp.id(8084012909738517)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8085515098738522)
,p_plugin_attribute_id=>wwv_flow_imp.id(8084012909738517)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8085972544738523)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8086298787738524)
,p_plugin_attribute_id=>wwv_flow_imp.id(8085972544738523)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8086692946738526)
,p_plugin_attribute_id=>wwv_flow_imp.id(8085972544738523)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8087061984738527)
,p_plugin_attribute_id=>wwv_flow_imp.id(8085972544738523)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8087464714738528)
,p_plugin_attribute_id=>wwv_flow_imp.id(8085972544738523)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8087878823738529)
,p_plugin_attribute_id=>wwv_flow_imp.id(8085972544738523)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8088299049738530)
,p_plugin_attribute_id=>wwv_flow_imp.id(8085972544738523)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8088696640738531)
,p_plugin_attribute_id=>wwv_flow_imp.id(8085972544738523)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8089086148738533)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808131948300852258)
,p_plugin_id=>wwv_flow_imp.id(8081014388738503)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
