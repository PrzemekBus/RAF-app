...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7972150784738201)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972432845738202)
,p_plug_template_id=>wwv_flow_imp.id(7972150784738201)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972788316738203)
,p_plug_template_id=>wwv_flow_imp.id(7972150784738201)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973073500738203)
,p_plug_template_id=>wwv_flow_imp.id(7972150784738201)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973369653738204)
,p_plug_template_id=>wwv_flow_imp.id(7972150784738201)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973667148738204)
,p_plug_template_id=>wwv_flow_imp.id(7972150784738201)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
