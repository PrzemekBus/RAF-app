...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8405883466755506)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_plug_template=>wwv_flow_imp.id(7972150784738201)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8406249641755508)
,p_plug_name=>'&APP_USER.'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(8406714482755509)
,p_region_id=>wwv_flow_imp.id(8406249641755508)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8407282792755510)
...
,p_list_id=>wwv_flow_imp.id(8404850133755502)
