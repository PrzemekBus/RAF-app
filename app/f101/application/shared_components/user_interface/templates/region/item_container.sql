...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7997717881738255)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998014116738256)
,p_plug_template_id=>wwv_flow_imp.id(7997717881738255)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998323108738256)
,p_plug_template_id=>wwv_flow_imp.id(7997717881738255)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7998607731738257)
,p_plug_template_id=>wwv_flow_imp.id(7997717881738255)
,p_name=>'Button Start'
