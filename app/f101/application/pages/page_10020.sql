...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8216504392739031)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8216688600739031)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8219002536739040)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8216504392739031)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8217686986739034)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8219424834739041)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8219701442739042)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8216688600739031)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8220459015739055)
...
,p_lov=>'.'||wwv_flow_imp.id(8220580442739055)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8217741606739034)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8217686986739034)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8218408366739037)
,p_event_id=>wwv_flow_imp.id(8217741606739034)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8221641119739062)
...
,p_internal_uid=>8221641119739062
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8222055960739063)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Application Appearance Settings Saved.'
,p_internal_uid=>8222055960739063
);
