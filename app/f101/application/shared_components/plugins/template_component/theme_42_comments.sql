...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8098990670738576)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1807984453170770296)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8099402625738582)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8099777828738583)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8100081252738584)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8100397113738585)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8100635417738586)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8105240718738601)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1807984453170770296)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8100944459738587)
,p_plugin_attribute_id=>wwv_flow_imp.id(8100635417738586)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8101378750738589)
,p_plugin_attribute_id=>wwv_flow_imp.id(8100635417738586)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8101757751738590)
,p_plugin_attribute_id=>wwv_flow_imp.id(8100635417738586)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8102158590738591)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8100635417738586)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8102444325738592)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8102707826738593)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8103094341738594)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8103382517738595)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8104821034738600)
,p_plugin_attribute_id=>wwv_flow_imp.id(8103382517738595)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8103626778738596)
,p_plugin_attribute_id=>wwv_flow_imp.id(8103382517738595)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8104052238738597)
,p_plugin_attribute_id=>wwv_flow_imp.id(8103382517738595)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8104483858738598)
,p_plugin_attribute_id=>wwv_flow_imp.id(8103382517738595)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8105240718738601)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8105516236738602)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8105834510738603)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8106143711738604)
,p_plugin_attribute_id=>wwv_flow_imp.id(8105834510738603)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8106546993738605)
,p_plugin_attribute_id=>wwv_flow_imp.id(8105834510738603)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8106986645738607)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1808117120603871799)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808116529098864342)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808172152768846221)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808324370481716992)
,p_plugin_id=>wwv_flow_imp.id(8098990670738576)
